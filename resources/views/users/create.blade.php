    ...
    <div class="card card-dark">
        ...
        <div class="card-body">        
                <div class="form-group row">
                    <label for="name" class="text-uppercase col-sm-2 col-form-label text-md-right ">{{ __('Role') }} <i class="fas fa-group"></i></label>
                ...
                <div class="form-group row">
                    <label for="name" class="text-uppercase col-sm-2 col-form-label text-md-right ">{{ __('Name') }} <i class="fas fa-user"></i></label>
                ...
                <div class="form-group row">
                    <label for="email" class="text-uppercase col-sm-2 col-form-label text-md-right ">{{ __('E-Mail') }} <i class="fas fa-envelope"></i></label>
                ...
                <div class="form-group row">
                    <label for="password" class="text-uppercase col-sm-2 col-form-label text-md-right">{{ __('Password') }} <i class="fas fa-lock"></i></label>
                ...
                <div class="form-group row">
                    <label for="password-confirm" class="text-uppercase col-sm-2 col-form-label text-md-right">{{ __('Confirm') }} <i class="fas fa-lock"></i></label>
