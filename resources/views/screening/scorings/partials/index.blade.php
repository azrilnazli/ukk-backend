...
<form method="GET"  action="{{ route('screening-scorings.search') }}">
    @csrf
    <div class="row mt-5">
      <div class="col-6">
        ...
        <div class="table-responsive">
          <table class="table table-condensed table-striped">
              <thead>
                  ...
                  @hasanyrole('screening-urusetia|screening-ketua')
                  <th width="*">Scoring</th>
                  @endhasanyrole
                  ...
                  <tr>
                    ...
                    @endif
                      ...
                      <td class="text-center">
                        ...
                        @if($row->screening_scoring)
                            <a class="btn btn-su btn-sm" href="{{ route('screening-scorings.show', $row->id) }}"><i class="fas fa-search"></i></a>
                        @else
                            <a class="btn btn-su btn-sm" href="{{ route('screening-scorings.show', $row->id) }}"><i class="fas fa-pencil-alt"></i></a>
                        @endif
                      </td>
                  </tr>
                  @endforeach
