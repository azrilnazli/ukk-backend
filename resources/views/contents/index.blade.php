...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><a href="/contents">{{ __('Contents') }}</a></li>
...
{{-- <form method="GET"  action="{{ route('contents.search') }}">
  @csrf
  <div class="row mt-5">
    <div class="col-3">
...
<div class="card card-dark mt-3">
    ...
    <div class="card-header clearfix">
      <h3 class="card-title">Total ( {{ $contents->total() }} )</h3>

      <div class="card-tools">
        <a class="btn-sm btn-primary " href="{{ route('contents.create') }}" role="button"><i class="fas fa-plus"></i> Create</a>
      </div>
        ...
        <table class="table table-condensed table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @role('super-admin')
                    <td>
                      <form action="{{ route('contents.destroy', $row->id)}}" method="post">
                        @csrf @method('DELETE')
                      <a class="btn btn-success btn-sm" href="{{ route('contents.edit', $row->id) }}">
