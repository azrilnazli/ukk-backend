...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><a href="/tenders">{{ __('Tender categories') }}</a></li>
        <li class="breadcrumb-item active" aria-current="page">Tender Category List</li>
    </ol>
</nav>
@stop
...
<div class="card card-dark mt-3">
    ...
    <div class="card-header clearfix">
      ...
      <div class="card-tools">
        <a class="btn-sm btn-primary " href="{{ route('tender-categories.create') }}" role="button"><i class="fas fa-plus"></i> Create</a>
      </div>
        ...
        <table class="table table-condensed table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @role('super-admin')
                    <td>
                      <form action="{{ route('tender-categories.destroy', $row->id)}}" method="post">
                        @csrf @method('DELETE')
                      <a class="btn btn-success btn-sm" href="{{ route('tender-categories.edit', $row->id) }}">
