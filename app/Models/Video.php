...
class Video extends Model
{
   ...
   /**
    ...
    public function getEncodingProgressAttribute(){
                 // check for progress file generated by ffmpeg
                if(Storage::disk('assets')->exists($this->id . "/progress_360p.txt")) {
                    $progress =  Storage::disk('assets')
                                 ->get( $this->id . "/progress_360p.txt" );
                    return $progress;
                } else {
                    return 0;
                }
